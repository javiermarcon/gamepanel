...
<form action="ListTemplates.php?type=<?php echo $url_server_type; ?>" name="templates" method="post">
<table border="1" class="tablez" width="700" cellpadding="0" cellspacing="0" align="center">
<tr background="css/<?php echo $config['theme']; ?>/img/smallGrad.png" height="20">
  <td align="center"><span class="top_titles">#</span></td>
  <td align="center" width="150"><span class="top_titles">Server Name</span></td>
  <td align="center" width="160"><span class="top_titles">Description</span></td>
  <td align="center"><span class="top_titles">File Path</span></td>
  <td align="center"><span class="top_titles">Default</span></td>
...
<tr valign="middle" style="background-color:<?php echo $bgColor; ?>" onmouseover="style.backgroundColor='<?php echo $bgOpp; ?>'" onmouseout="style.backgroundColor='<?php echo $bgColor; ?>'">
  ...
  <td align="center"><span class="rowz_alt"><b><?php echo $long_name; ?></b></span></td>
  <td align="center"><span class="rowz_alt"><?php echo $desc; ?></span></td>
  <td align="left"><span class="rowz_alt"><?php echo $file; ?></span></td>
...
?>
  ...
  <td align="left"><span class="rowz_alt"><?php echo $available; ?></span></td>
  <td align="center" valign="middle"><input type="button" name="edit" id="edit" value="Edit" style="width:100%" onClick="window.location.href='GameTemplateEdit.php?id=<?php echo $id; ?>'"></td>
<?php } ?>
</table>
...
Click <a href="ListTemplates.php?type=<?php echo $url_server_type; ?>">here</a> to go back.
...
<?php
// Output
echo 'Row(s) <b>' . $delList . '</b> will deleted from the database and remote server.<br /><br />';
...
<input type="hidden" name="previous_page" value="ListTemplates.php">
